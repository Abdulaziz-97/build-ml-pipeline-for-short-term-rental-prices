...
def go(args):
    ...
    artifact = wandb.Artifact(args.output_artifact, type="model_export", description="Random Forest Model", metadata=rf_config)
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    non_ordinal_categorical_preproc = make_pipeline(SimpleImputer(strategy="most_frequent"), OneHotEncoder(handle_unknown="ignore"))
    ######################################
